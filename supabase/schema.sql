...
-- ============================================================
-- 4B. WHATSAPP SUBSCRIBERS AND MESSAGE LOGS
-- ============================================================
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_whatsapp_messages_dedupe_key ON public.whatsapp_messages(dedupe_key) WHERE dedupe_key IS NOT NULL;
